 ...
 */
function lawyeriax_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';

	$wp_customize->get_control( 'background_color' )->panel = 'custom_colors_panel';
	$wp_customize->get_control( 'background_color' )->section = 'body_colors';

	$wp_customize->remove_section( 'colors' );
	$wp_customize->remove_section( 'background_image' );

}
add_action( 'customize_register', 'lawyeriax_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function lawyeriax_customize_preview_js() {

	wp_enqueue_script( 'lawyeriax_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );

	wp_enqueue_style( 'lawyeriax-admin-stylesheet', get_template_directory_uri() . '/css/admin-style.css', '1.0.0' );

}
add_action( 'customize_preview_init', 'lawyeriax_customize_preview_js' );


/**
 * Add repeater PHP and enqueue repeater JS.
 */
require_once( 'class/customizer-repeater/repeater-general-control.php' );
require_once( 'class/category-selector-control.php' );
 ...
 * Sanitize Category
 */
function lawyeriax_sanitize_category_dropdown( $input ) {
	return intval( $input );
}
 ...
 */
function lawyeriax_sanitize_dropdown_pages( $page_id, $setting ) {
